...
function Tour_Enquiry() {
    ...
    {
        axios
            .get("http://localhost:5000/viewenquiry")
            .then((res) => 
            {
                if (res.status == 200) 
                {
    ...
    if (data.length > 0 && window.$) 
      ...
      table.DataTable().destroy();   // 🔴 IMPORTANT
    }
                ...
                <div className="col-sm-10" id="Traveller_details">
                    <div className="row" >
                        <div id="Form-container">
                            <h2 id="Headings">View Enquiry</h2>
                                            ...
                                            data.map((row) => 
                                            {
                                                return (
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <Link to={`/enquiry-replay/${row.enquiry_id}`} className="btn btn-primary" id="btn_edit">View</Link>
                                                        </td>
                                                    </tr>
                                                )
                                            }
