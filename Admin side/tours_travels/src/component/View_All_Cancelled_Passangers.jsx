...
function Tour_All_Cancelled_Passanger() {
    ...
    {
        axios
            .get(`http://localhost:5000/view_all_cancelled_passanger`)
            .then((res) => 
            {
                if (res.status == 200) 
                {
                ...
                <div className="col-sm-10" id="Traveller_details">
                    <div className="row" >
                        <div id="Form-container">
                            <h2 id="Headings">All Cancelled Passanger Details</h2><br/>
...
export default Tour_All_Cancelled_Passanger;