...
function View_Package_Summary() {

    const {id} = useParams();
    const [data, setData] = useState([]);
    const [packagesummary,setsummary] = useState([]);
    ...
    {
        axios
            .get(`http://localhost:5000/view_package_bookings/${id}`)
            .then((res) => 
            {
                if (res.status == 200) 
                {
    ...
    {
        axios
            .get(`http://localhost:5000/view_indiviual_package_summary/${id}`)
            .then((res) => 
            {
                if (res.status == 200) 
                {
            ...
            <div className="row">
                ...
                <div className="col-sm-10" id="Traveller_details">
                    <div className="row" >
                        ...
                        <center >
                            <Link to="/dashboard"id="Booking_Status">Back</Link>
                        </center><br/>

                        <h2 id="Headings_1">Package Summary</h2><br/>

                            <div className="row">
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            <img src="/Image/ebook.gif" alt="My GIF" width="80" height="80"/>
                                            <p id="count_card_heading_1">Total Bookings</p>
                                            <p id="counting_1">{packagesummary.total_bookings}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                            <center>
                                            <img src="/Image/hourglass.gif" alt="My GIF" width="80" height="80"/>
                                            ...
                                            <p id="count_card_heading_1">Total Pending Booking</p>
                                            <p id="counting_1">{packagesummary.total_pending_bookings}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                            <center>
                                            <img src="/Image/book.gif" alt="My GIF" width="80" height="80"/>
                                            {/* <svg id="Count_Image" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#000000"><path d="M38-160v-94q0-35 18-63.5t50-42.5q73-32 131.5-46T358-420q62 0 120 14t131 46q32 14 50.5 42.5T678-254v94H38Zm700 0v-94q0-63-32-103.5T622-423q69 8 130 23.5t99 35.5q33 19 52 47t19 63v94H738ZM358-481q-66 0-108-42t-42-108q0-66 42-108t108-42q66 0 108 42t42 108q0 66-42 108t-108 42Zm360-150q0 66-42 108t-108 42q-11 0-24.5-1.5T519-488q24-25 36.5-61.5T568-631q0-45-12.5-79.5T519-774q11-3 24.5-5t24.5-2q66 0 108 42t42 108ZM98-220h520v-34q0-16-9.5-31T585-306q-72-32-121-43t-106-11q-57 0-106.5 11T130-306q-14 6-23 21t-9 31v34Zm260-321q39 0 64.5-25.5T448-631q0-39-25.5-64.5T358-721q-39 0-64.5 25.5T268-631q0 39 25.5 64.5T358-541Zm0 321Zm0-411Z"/></svg> */}
                                            <p id="count_card_heading_1">Total Confirm Bookings</p>
                                            <p id="counting_1">{packagesummary.total_confirm_bookings}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                            <center>
                                            <img src="/Image/cancel_1.gif" alt="My GIF" width="80" height="80"/>
                                            {/* <svg id="Count_Image" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#000000"><path d="M38-160v-94q0-35 18-63.5t50-42.5q73-32 131.5-46T358-420q62 0 120 14t131 46q32 14 50.5 42.5T678-254v94H38Zm700 0v-94q0-63-32-103.5T622-423q69 8 130 23.5t99 35.5q33 19 52 47t19 63v94H738ZM358-481q-66 0-108-42t-42-108q0-66 42-108t108-42q66 0 108 42t42 108q0 66-42 108t-108 42Zm360-150q0 66-42 108t-108 42q-11 0-24.5-1.5T519-488q24-25 36.5-61.5T568-631q0-45-12.5-79.5T519-774q11-3 24.5-5t24.5-2q66 0 108 42t42 108ZM98-220h520v-34q0-16-9.5-31T585-306q-72-32-121-43t-106-11q-57 0-106.5 11T130-306q-14 6-23 21t-9 31v34Zm260-321q39 0 64.5-25.5T448-631q0-39-25.5-64.5T358-721q-39 0-64.5 25.5T268-631q0 39 25.5 64.5T358-541Zm0 321Zm0-411Z"/></svg> */}
                                            <p id="count_card_heading_1">Total Cancelled Bookings</p>
                                            <p id="counting_1">{packagesummary.total_cancelled_bookings}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                            ...
                                            <p id="counting_1">{packagesummary.total_persons}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                            ...
                                            <p id="counting_1">{packagesummary.total_active_person}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            ...
                                            <p id="counting_1">{packagesummary.total_cancelled_person}</p>
                                        </center>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            ...
                                            <p id="counting_1">₹{packagesummary.total_paid_amount}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            ...
                                            <p id="counting_1">₹{packagesummary.total_active_amount}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            ...
                                            <p id="counting_1">₹{packagesummary.total_due_amount}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            ...
                                            <p id="counting_1">₹{packagesummary.total_refund_amount}</p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div id="count_cards_1">
                                    <div id="card_details_1">
                                        <center>
                                            ...
                                            <p id="counting_1">₹{packagesummary.total_cancellation_charge}</p>
                                        </center>
                                ...
                                <tbody>
                                    {
                                        bookingSummary.map((row) =>
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><Link id="btn_edit_1" to={`/view-passanger/${row.booking_id}`} className="btn btn-primary" > View </Link></td>
                                            </tr>
                                        )}
                                    )}
                                </tbody>
                            ...
                            <h2 id="Headings">Seat Details</h2><br/>
...
export default View_Package_Summary;