...
function Dashboard(){
    ...
    const [total_enquiry,set_enquiry_data] = useState([]);
    const [total_income,set_income_Data] = useState([]);
    const [all_booking_data , set_all_booking_data] = useState([])
    const [pending_booking_data, set_pending_booking_Data] = useState([]);
    const [confirm_booking_data, set_confirm_booking_Data] = useState([]);
    const [cancelled_booking_data, set_cancelled_booking_Data] = useState([]);
    ...
    {
        axios
            .get("http://localhost:5000/totalpackages")
            .then((res) => 
            {
                if (res.status == 200) 
                {
    ...
    {
        axios
            .get("http://localhost:5000/totalEnquiry")
            .then((res) => 
            {
                if (res.status == 200) 
                {
                    const json = res.data
                    set_enquiry_data(json)
                }
            })
            .catch((err) => 
            {
    ...
    {
        axios
            .get("http://localhost:5000/totalBooking")
            .then((res) => 
            {
                if (res.status == 200) 
                {
                    const json = res.data
                    set_all_booking_data(json)
                }
            })
            .catch((err) => 
            {
    ...
    {
        axios
            .get("http://localhost:5000/totalPendingBooking")
            .then((res) => 
            {
                if (res.status == 200) 
                {
                    const json = res.data
                    set_pending_booking_Data(json)
                }
            })
            .catch((err) => 
            {
    ...
    {
        axios
            .get("http://localhost:5000/totalConfirmBooking")
            .then((res) => 
            {
                if (res.status == 200) 
                {
                    const json = res.data
                    set_confirm_booking_Data(json)
                }
            })
            .catch((err) => 
            {
    ...
    {
        axios
            .get("http://localhost:5000/totalCancleBooking")
            .then((res) => 
            {
                if (res.status == 200) 
                {
                    const json = res.data
                    set_cancelled_booking_Data(json)
                }
            })
            .catch((err) => 
            {
    ...
    {
        axios
            .get("http://localhost:5000/totalIncome")
            .then((res) => 
            {
                if (res.status == 200) 
                {
                    const json = res.data
                    set_income_Data(json)
                }
            })
            .catch((err) => 
            {
                    ...
                    <div className="row" >
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    <img src="/Image/map.gif" alt="My GIF" width="80" height="80"/>
                                    {/* <svg  id="Count_Image" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#000000"><path d="M638-511v-1.5 1.5-189 189ZM170-142q-17 9-33.5-1T120-173v-558q0-13 7.5-23t19.5-15l202-71 263 92 178-71q17-8 33.5 1.5T840-788v388q-11-21-26-38.5T780-470v-284l-142 54v189q-16 2-31 5t-29 8v-202l-196-66v540l-212 84Zm10-65 142-54v-505l-142 47v512Zm474-5q38 0 64-26t26-64q0-38-26-64t-64-26q-38 0-64 26t-26 64q0 38 26 64t64 26Zm0 60q-62 0-106-44t-44-106q0-63 44-106.5T654-452q63 0 106.5 43.5T804-302q0 23-6.5 44T779-219l101 101-38 38-101-100q-19 14-40.5 21t-46.5 7ZM322-766v505-505Z"/></svg> */}
                                    <p id="count_card_heading">Total Packages</p>
                                    <p id="counting">{tour_data.count}</p>
                                </center>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                 <center>
                                    ...
                                    <p id="count_card_heading">Total Users</p>
                                    <p id="counting">{user_data.count}</p>
                                </center>
                            </div>
                        </div>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    <img src="/Image/message.gif" alt="My GIF" width="80" height="80"/>
                                    ...
                                    <p id="count_card_heading">Total Enquiry</p>
                                    <p id="counting">{total_enquiry.count}</p>
                                </center>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    <img src="/Image/money.gif" alt="My GIF" width="80" height="80"/>
                                    {/* <svg id="Count_Image" xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#000000"><path d="M540-420q-50 0-85-35t-35-85q0-50 35-85t85-35q50 0 85 35t35 85q0 50-35 85t-85 35ZM220-280q-24.75 0-42.37-17.63Q160-315.25 160-340v-400q0-24.75 17.63-42.38Q195.25-800 220-800h640q24.75 0 42.38 17.62Q920-764.75 920-740v400q0 24.75-17.62 42.37Q884.75-280 860-280H220Zm100-60h440q0-42 29-71t71-29v-200q-42 0-71-29t-29-71H320q0 42-29 71t-71 29v200q42 0 71 29t29 71Zm480 180H100q-24.75 0-42.37-17.63Q40-195.25 40-220v-460h60v460h700v60ZM220-340v-400 400Z"/></svg>  */}                                 
                                     <p id="count_card_heading">Total Income </p> 
                                    <p id="counting">₹{total_income.count} </p>
                                </center>
                            </div>
                        </div>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    ...
                                    <p id="count_card_heading">Pending Bookings</p>
                                    <p id="counting">{pending_booking_data.count}</p>
                                </center>
                            </div>
                        </div>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    ...
                                    <p id="count_card_heading">Confirm Bookings</p>
                                    <p id="counting">{confirm_booking_data.count}</p>
                                </center>
                            </div>
                        </div>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    <img src="/Image/cross.gif" alt="My GIF" width="80" height="80"/>
                                    ...
                                    <p id="count_card_heading">Cancle Bookings</p>
                                    <p id="counting">{cancelled_booking_data.count}</p>
                                </center>
                            </div>
                        </div>
                        ...
                        <div id="count_cards">
                            <div id="cards_details">
                                <center>
                                    <img src="/Image/booked.gif" alt="My GIF" width="80" height="80"/>   
                                    ...
                                    <p id="count_card_heading">Total Bookings</p>
                                    <p id="counting">{all_booking_data.count}</p>
                                </center>
                                            ...
                                            return (
                                                <tr>
                                                    ...
                                                    <td className="action-column">
                                                        <Link to={`/package-summary/${row.tour_id}`} className="btn btn-primary btn-sm" id="btn_add_image"style={{padding:"8px"}}>View</Link>
                                                    </td>
                                                </tr>
                                            );
                                        })}
